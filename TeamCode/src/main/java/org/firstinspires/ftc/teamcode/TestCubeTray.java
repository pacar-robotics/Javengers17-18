...
@TeleOp(name = "TestCubeTray", group = "Test")
public class TestCubeTray extends rr_OpMode {
    rr_Robot robot;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //set the tray servos to a starting position
        robot.setTrayFlipPosition(this, robot.trayFlipPosition);
        robot.setTrayHeightPosition(this, robot.trayHeightPosition);
