...
public class rr_Constants {
    ...
    final static float TRAY_FLIP_COLLECTION_POSITION=0.6f;
    final static float TRAY_FLIP_CRYPTO_ALIGN_POSITION=0.225f;
    ...
    final static float CUBE_HOLDER_HOLD_POSITION=0.55f;
    final static float CUBE_HOLDER_RELEASE_POSITION=0.0f;
    ...
    final static float JEWEL_ARM_UP = 0.92f;

    //final static float JEWEL_ARM_DOWN_READ = .89f;
    final static float JEWEL_ARM_DOWN_PUSH = .5f;
